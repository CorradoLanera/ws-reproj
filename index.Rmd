...
what if I have private data (stored centralized, visible by colleague only)?
...
<!-- - Start .orange[easy] and .orange[slow] but pointing **after** conclusion! -->

<!-- - Speed go to zero if the work is not correct! -->

<!-- - **Bugs will arrive**. For sure! -->
